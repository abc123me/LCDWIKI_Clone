...
uint16_t LCDWIKI_KBV::color565(uint8_t r, uint8_t g, uint8_t b)
{
...
void LCDWIKI_KBV::drawPx(int16_t x, int16_t y, uint16_t color)
{
...
void LCDWIKI_KBV::fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color)
{
	int16_t end;
	if (w < 0) 
	{
...
void LCDWIKI_KBV::setRotation(uint8_t r)
{
...
//2  :  180 degree
//3  :  270 degree
uint8_t LCDWIKI_KBV::getRotation(void) const
{
	return rotation;
}
